...
execute if entity @s[scores={ija-a4-counter=1152..1703,ija-a4-cooldown=1}] at @s run function ija-one-block:generated/phase/04
scoreboard players set @s[scores={ija-a4-counter=1704,ija-a4-cooldown=1}] ija-a4-upgrade-seconds-left 50
execute if entity @s[scores={ija-a4-counter=1704,ija-a4-cooldown=1}] run function ija-one-block:generated/phase/start-upgrade
execute if entity @s[scores={ija-a4-counter=1705..2328,ija-a4-cooldown=1}] at @s run function ija-one-block:generated/phase/05
scoreboard players set @s[scores={ija-a4-counter=2329,ija-a4-cooldown=1}] ija-a4-upgrade-seconds-left 60
execute if entity @s[scores={ija-a4-counter=2329,ija-a4-cooldown=1}] run function ija-one-block:generated/phase/start-upgrade
execute if entity @s[scores={ija-a4-counter=2330..3074,ija-a4-cooldown=1}] at @s run function ija-one-block:generated/phase/06
scoreboard players set @s[scores={ija-a4-counter=3075,ija-a4-cooldown=1}] ija-a4-upgrade-seconds-left 70
execute if entity @s[scores={ija-a4-counter=3075,ija-a4-cooldown=1}] run function ija-one-block:generated/phase/start-upgrade
execute if entity @s[scores={ija-a4-counter=3076..3814,ija-a4-cooldown=1}] at @s run function ija-one-block:generated/phase/07
scoreboard players set @s[scores={ija-a4-counter=3815,ija-a4-cooldown=1}] ija-a4-upgrade-seconds-left 80
execute if entity @s[scores={ija-a4-counter=3815,ija-a4-cooldown=1}] run function ija-one-block:generated/phase/start-upgrade
execute if entity @s[scores={ija-a4-counter=3816..4589,ija-a4-cooldown=1}] at @s run function ija-one-block:generated/phase/08
scoreboard players set @s[scores={ija-a4-counter=4590,ija-a4-cooldown=1}] ija-a4-upgrade-seconds-left 90
execute if entity @s[scores={ija-a4-counter=4590,ija-a4-cooldown=1}] run function ija-one-block:generated/phase/start-upgrade
execute if entity @s[scores={ija-a4-counter=4591..5367,ija-a4-cooldown=1}] at @s run function ija-one-block:generated/phase/09
scoreboard players set @s[scores={ija-a4-counter=5368,ija-a4-cooldown=1}] ija-a4-upgrade-seconds-left 100
execute if entity @s[scores={ija-a4-counter=5368,ija-a4-cooldown=1}] run function ija-one-block:generated/phase/start-upgrade
execute if entity @s[scores={ija-a4-counter=5369..6248,ija-a4-cooldown=1}] at @s run function ija-one-block:generated/phase/10
scoreboard players set @s[scores={ija-a4-counter=6249,ija-a4-cooldown=1}] ija-a4-upgrade-seconds-left 110
execute if entity @s[scores={ija-a4-counter=6249,ija-a4-cooldown=1}] run function ija-one-block:generated/phase/start-upgrade
execute if entity @s[scores={ija-a4-counter=6247,ija-a4-cooldown=1}] at @s unless block ~2 ~-2 ~ minecraft:end_portal_frame run function ija-one-block:end-portal/spawn
scoreboard players set @s[scores={ija-a4-counter=6262..,ija-a4-cooldown=1}] ija-a4-counter 6261
execute if entity @s[scores={ija-a4-counter=6250..,ija-a4-cooldown=1}] at @s run function ija-one-block:generated/phase/afterphases