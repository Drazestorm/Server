...
execute at @s run summon minecraft:magma_cube ~ ~1.6 ~ {Tags:["ija-a4-monster-party-mob"]}
execute if entity @s[scores={ija-a4-random-mob-amount=2..}] at @s run summon minecraft:magma_cube ~ ~1.6 ~ {Tags:["ija-a4-monster-party-mob"]}
