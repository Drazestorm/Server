...
execute at @s run summon minecraft:zombie_nautilus ~ ~1.6 ~ {Passengers:[{id:"minecraft:drowned",equipment:{head:{id:"minecraft:copper_helmet",count:1},mainhand:{id:"minecraft:trident",count:1}}}],variant:"minecraft:warm"}
