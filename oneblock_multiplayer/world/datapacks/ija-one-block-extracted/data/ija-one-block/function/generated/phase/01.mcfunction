...
execute if entity @s[scores={ija-a4-counter=49}] run function ija-one-block:generated/helper/04
execute if entity @s[scores={ija-a4-counter=49}] as @a[distance=..200] run function ija-one-block:generated/helper/05 {music:"music.overworld.flower_forest"}
...
execute if entity @s[scores={ija-a4-counter=116}] at @s run fill ~ ~ ~ ~ ~ ~ minecraft:chest[facing=east]{LootTable:"ija-one-block:01-regular"} replace minecraft:barrier
execute if entity @s[scores={ija-a4-counter=116}] at @s run function ija-one-block:generated/helper/06
...
execute if entity @s[scores={ija-a4-counter=166}] at @s run fill ~ ~ ~ ~ ~ ~ minecraft:chest[facing=east]{LootTable:"ija-one-block:01-regular"} replace minecraft:barrier
execute if entity @s[scores={ija-a4-counter=166}] at @s run function ija-one-block:generated/helper/06
...
execute if entity @s[scores={ija-a4-counter=220}] at @s run fill ~ ~ ~ ~ ~ ~ minecraft:chest[facing=east]{LootTable:"ija-one-block:01-regular"} replace minecraft:barrier
execute if entity @s[scores={ija-a4-counter=220}] at @s run function ija-one-block:generated/helper/06
...
execute if entity @s[scores={ija-a4-counter=275}] at @s run fill ~ ~ ~ ~ ~ ~ minecraft:chest[facing=east]{LootTable:"ija-one-block:01-regular"} replace minecraft:barrier
execute if entity @s[scores={ija-a4-counter=275}] at @s run function ija-one-block:generated/helper/06
...
execute if entity @s[scores={ija-a4-counter=282}] at @s run fill ~ ~ ~ ~ ~ ~ minecraft:chest[facing=east]{LootTable:"ija-one-block:01-gift"} replace minecraft:barrier
execute if entity @s[scores={ija-a4-counter=282}] at @s run function ija-one-block:generated/helper/01