...
execute at @s run summon minecraft:zombie_nautilus ~ ~1.6 ~ {equipment:{body:{id:"minecraft:iron_nautilus_armor",count:1}},variant:"minecraft:temperate",Passengers:[{id:"minecraft:drowned",equipment:{head:{id:"minecraft:iron_helmet",count:1},chest:{id:"minecraft:leather_chestplate",count:1},legs:{id:"minecraft:leather_leggings",count:1},feet:{id:"minecraft:leather_boots",count:1},mainhand:{id:"minecraft:trident",count:1}}}],Tags:["ija-a4-monster-party-mob"]}
