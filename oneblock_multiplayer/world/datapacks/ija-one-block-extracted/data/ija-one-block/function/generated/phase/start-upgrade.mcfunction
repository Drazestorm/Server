...
summon minecraft:text_display ~ ~1.7 ~ {alignment:"center",billboard:"vertical",brightness:{block:15,sky:15},line_width:999,see_through:true,Tags:["ija-a4-upgrade-message"]}
